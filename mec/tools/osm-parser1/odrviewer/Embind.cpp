...
EMSCRIPTEN_BINDINGS(OpenDriveMap)
{
    ...
    emscripten::class_<LanesMesh, emscripten::base<RoadsMesh>>("LanesMesh")
        ...
        .property("lane_start_type", &LanesMesh::lane_start_type);
    ...
    emscripten::class_<RoadObjectsMesh, emscripten::base<RoadsMesh>>("RoadObjectsMesh")
        ...
        .function("get_idx_interval_road_object_type", &RoadObjectsMesh::get_idx_interval_road_object_type)
        .property("road_object_start_indices", &RoadObjectsMesh::road_object_start_indices)
        .property("road_object_type", &RoadObjectsMesh::road_object_type);

    emscripten::class_<RoadNetworkMesh>("RoadNetworkMesh")
        .smart_ptr<std::shared_ptr<RoadNetworkMesh>>("shared_ptr<RoadNetworkMesh>")
        ...
        .property("refline", &RoadNetworkMesh::refline);
    ...
    emscripten::class_<mapi::tilecache>("tilecache")
        .constructor<>()
        .function("bind_map", &mapi::tilecache::bind_map)
        .function("add_tile", &mapi::tilecache::add_tile)
        .function("get_mesh", &mapi::tilecache::get_mesh)
        .function("release_mesh", &mapi::tilecache::release_mesh)
        .function("query_unloaded_blocks", &mapi::tilecache::query_unloaded_blocks)
        .function("get_mapid", &mapi::tilecache::get_mapid)
        .function("get_map_georef", &mapi::tilecache::get_map_georef)
        .function("get_mapoffset", &mapi::tilecache::get_mapoffset)
        .function("map_available", &mapi::tilecache::map_available)
        .function("filter_loaded_blocks", &mapi::tilecache::filter_loaded_blocks)
        .function("lock_blocks", &mapi::tilecache::lock_blocks)
        .function("unlock_blocks", &mapi::tilecache::unlock_blocks)
        .function("release_blocks", &mapi::tilecache::release_blocks)
        .function("get_singlelight_blocks", &mapi::tilecache::get_singlelight_blocks)
        .function("get_road_height", &mapi::tilecache::get_road_height)
        .function("get_junctioncenter_byappr", &mapi::tilecache::get_junctioncenter_byappr);
