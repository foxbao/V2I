...
public:
	...
	std::vector<Curve> get_curves_enu(CurveType type=CurveType::center_curve);
	std::vector<Eigen::Vector3d> get_curve(uint64_t lane_id,CurveType type = CurveType::center_curve);
