...
public:
	...
	proxy::myIF1 method2(proxy::myIF1& val1);
...
namespace skeleton {
	...
	rpchost get_myIF1_service(void);
};
...
private:
	virtual rpchost get_host(void) {
		return skeleton::get_myIF1_service();
	}
...
namespace skeleton {
	...
	rpchost get_myIF3_singleton_service(void);
};
...
private:
	virtual rpchost get_host(void) {
		return skeleton::get_myIF3_singleton_service();
	}
	virtual const char* get_class(void) {
		return "mytest.myIF3_singleton";
	}
};
